...
INT_WRITE_ERROR:
	MOV BYTE[INT_RET_CODE], 0x0A ; <- Error is misleading, fix this crap
	JMP RET_CODE_INT
...
INT_SYNTAX_ERROR:
	MOV BYTE[INT_RET_CODE], 0x42
	JMP RET_CODE_INT

INT_FILE_EXISTS_ERROR:
	MOV BYTE[INT_RET_CODE], 0x44
	JMP RET_CODE_INT

; INT_FILE_NOT_DIR_ERROR:
	; MOV BYTE[INT_RET_CODE], 0x46
	; JMP RET_CODE_INT

INT_DIR_NOT_EMPTY_ERROR:
	MOV BYTE[INT_RET_CODE], 0x47
	JMP RET_CODE_INT

INT_OUT_OF_SPACE_ERROR:
	MOV BYTE[INT_RET_CODE], 0x49
	JMP RET_CODE_INT

; INT_MAX_DIR_DEPTH:
	; MOV BYTE[INT_RET_CODE], 0x4A
	; JMP RET_CODE_INT
