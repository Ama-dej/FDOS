...
.LABEL_HACK:
	...
	CMP DI, WORD[FILE_SIZE_UPPER]
        ...
        CMP WORD[FILE_SIZE_UPPER], 0
        JZ .CHECK_IF_DX_HIGHER
        JMP .SUBTRACT
...
.SUBTRACT:
	...
	; CMP WORD[ES:SI + 30], DX
	; JGE .POP

	; CMP WORD[ES:SI + 28], AX
	; JGE .POP

	; MOV WORD[ES:SI + 30], DX
	; MOV WORD[ES:SI + 28], AX
...
.OK:
	...
	MOV DI, DX
	ADD DI, WORD[FILE_SIZE_LOWER]
	JC .PROCEED

	CMP DI, WORD[BYTES_PER_CLUSTER]
	JG .PROCEED

	CALL READ_DATA ; <- Treba vreč error če ne uspe
...
.COPY_DATA:
	...
	CMP CX, 512 ; <- Najdi boljši način za to šalabajzarijo!!!!!1
	JB .OUT
