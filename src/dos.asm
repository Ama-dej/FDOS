...
FIND_COMMAND:
	...
	MOV WORD[COMMAND_START], COMMAND_PARSED
...
EXPLICIT_EXECUTE:
	INC WORD[COMMAND_START]

; TODO:
; - spiš tko k se spodob
LOAD_BINARY:
...
.NO_ERROR:
	...
	CMP AX, WORD[DIRECTORY_RET_FIRST_SECTOR]
	JE .SAME_DIR ; <- Stupid idiotic hack, this entire procedure is crap and has to be rewritten
...
VER:
	MOV AH, 0x01
	MOV SI, VER_MSG
	MOV CX, VER_MSG_END - VER_MSG
	INT 0x20

	JMP DOS_START

VER_MSG: DB "FDOS v0.1RNR, (c) 2022-24 Amadej Arh, Vegovacraft Corp.", 0x0A, 0x0D, 0x0A, 0x0D
VER_MSG_END:
...
DOS_STARTUP_MSG: DB "FDOS kernel -> 0x"
DOS_STARTUP_MSG_END:

MEMORY_MSG: DB "Conventional RAM -> "
MEMORY_MSG_END:
...
STATUS_CODE_TABLE:
STATUS_NO_ERROR: DB 0x00
STATUS_BAD_COMMAND: DB 0x01
STATUS_ADDRESS_MARK_NOT_FOUND: DB 0x02
STATUS_WRITE_PROTECT: DB 0x03
STATUS_SECTOR_NOT_FOUND: DB 0x04
STATUS_HDD_RESET_FAILED: DB 0x05
STATUS_DISKETTE_CHANGED: DB 0x06
STATUS_HDD_BAD_TABLE: DB 0x07
STATUS_DMA_OVERRUN: DB 0x08
STATUS_DMA_64K_ACCESS: DB 0x09
STATUS_HDD_BAD_SECTOR_FLAG: DB 0x0A
STATUS_HDD_BAD_CYLINDER: DB 0x0B
STATUS_INVALID_MEDIA: DB 0x0C
STATUS_HDD_INVALID_NUMBER_OF_SECTORS: DB 0x0D
STATUS_HDD_CONTROLLED_DATA_ADDRESS_MARK: DB 0x0E
STATUS_HDD_DMA_LEVEL_OUT_OF_RANGE: DB 0x0F
STATUS_ECC_ERROR_ON_READ: DB 0x10
STATUS_DATA_FIXED_BY_ECC: DB 0x11
STATUS_CONTROLLER_ERROR: DB 0x20
STATUS_SEEK_FAILURE: DB 0x40
;
STATUS_INVALID_COMMAND_OR_PROGRAM: DB 0x41
STATUS_INVALID_SYNTAX: DB 0x42
STATUS_ENTRY_NOT_FOUND: DB 0x43
STATUS_ENTRY_EXISTS: DB 0x44
STATUS_ENTRY_IS_DIRECTORY: DB 0x45
STATUS_ENTRY_NOT_DIRECTORY: DB 0x46
STATUS_DIRECTORY_NOT_EMPTY: DB 0x47
STATUS_DIRECTORY_FULL: DB 0x48
STATUS_OUT_OF_SPACE: DB 0x49
STATUS_DEPTH_LIMIT: DB 0x4A
STATUS_DIRECTORY_IN_USE: DB 0x4B
;
STATUS_DRIVE_TIMEOUT: DB 0x80
STATUS_HDD_TIMEOUT: DB 0xAA
STATUS_HDD_UNDEFINED: DB 0xBB
STATUS_HDD_WRITE_FAULT: DB 0xCC
STATUS_HDD_STATUS_ERROR: DB 0xE0
STATUS_SENSE_FAILED: DB 0xFF
STATUS_CODE_TABLE_END:

MSG_ADDRESS_TABLE:
ADDRESS_NO_ERROR: DW MSG_NO_ERROR
ADDRESS_BAD_COMMAND: DW MSG_BAD_COMMAND
ADDRESS_ADDRESS_MARK_NOT_FOUND: DW MSG_ADDRESS_MARK_NOT_FOUND
ADDRESS_WRITE_PROTECT: DW MSG_WRITE_PROTECT
ADDRESS_SECTOR_NOT_FOUND: DW MSG_SECTOR_NOT_FOUND
ADDRESS_HDD_RESET_FAILED: DW MSG_HDD_RESET_FAILED
ADDRESS_DISKETTE_CHANGED: DW MSG_DISKETTE_CHANGED
ADDRESS_HDD_BAD_TABLE: DW MSG_HDD_BAD_TABLE
ADDRESS_DMA_OVERRUN: DW MSG_DMA_OVERRUN
ADDRESS_DMA_64K_ACCESS: DW MSG_DMA_64K_ACCESS
ADDRESS_HDD_BAD_SECTOR_FLAG: DW MSG_HDD_BAD_SECTOR_FLAG
ADDRESS_HDD_BAD_CYLINDER: DW MSG_HDD_BAD_CYLINDER
ADDRESS_INVALID_MEDIA: DW MSG_INVALID_MEDIA
ADDRESS_HDD_INVALID_NUMBER_OF_SECTORS: DW MSG_HDD_INVALID_NUMBER_OF_SECTORS
ADDRESS_HDD_CONTROLLED_DATA_ADDRESS_MARK: DW MSG_HDD_CONTROLLED_DATA_ADDRESS_MARK
ADDRESS_HDD_DMA_LEVEL_OUT_OF_RANGE: DW MSG_HDD_DMA_LEVEL_OUT_OF_RANGE
ADDRESS_ECC_ERROR_ON_READ: DW MSG_ECC_ERROR_ON_READ
ADDRESS_DATA_FIXED_BY_ECC: DW MSG_DATA_FIXED_BY_ECC
ADDRESS_CONTROLLER_ERROR: DW MSG_CONTROLLER_ERROR
ADDRESS_SEEK_FAILURE: DW MSG_SEEK_FAILURE
;
ADDRESS_INVALID_COMMAND_OR_PROGRAM: DW MSG_INVALID_COMMAND_OR_PROGRAM
ADDRESS_INVALID_SYNTAX: DW MSG_INVALID_SYNTAX
ADDRESS_ENTRY_NOT_FOUND: DW MSG_ENTRY_NOT_FOUND
ADDRESS_ENTRY_EXISTS: DW MSG_ENTRY_EXISTS
ADDRESS_ENTRY_IS_DIRECTORY: DW MSG_ENTRY_IS_DIRECTORY
ADDRESS_ENTRY_NOT_DIRECTORY: DW MSG_ENTRY_NOT_DIRECTORY
ADDRESS_DIRECTORY_NOT_EMPTY: DW MSG_DIRECTORY_NOT_EMPTY
ADDRESS_DIRECTORY_FULL: DW MSG_DIRECTORY_FULL
ADDRESS_OUT_OF_SPACE: DW MSG_OUT_OF_SPACE
ADDRESS_DEPTH_LIMIT: DW MSG_DEPTH_LIMIT
ADDRESS_DIRECTORY_IN_USE: DW MSG_DIRECTORY_IN_USE
;
ADDRESS_DRIVE_TIMEOUT: DW MSG_DRIVE_TIMEOUT
ADDRESS_HDD_TIMEOUT: DW MSG_HDD_TIMEOUT
ADDRESS_HDD_UNDEFINED: DW MSG_HDD_UNDEFINED
ADDRESS_HDD_WRITE_FAULT: DW MSG_HDD_WRITE_FAULT
ADDRESS_HDD_STATUS_ERROR: DW MSG_HDD_STATUS_ERROR
ADDRESS_SENSE_FAILED: DW MSG_SENSE_FAILED
MSG_ADDRESS_TABLE_END:

MSG_TABLE:
MSG_NO_ERROR: DB 0x00
MSG_BAD_COMMAND: DB "Bad command passed to drive", 0x00
MSG_ADDRESS_MARK_NOT_FOUND: DB 0x00
MSG_WRITE_PROTECT: DB "Diskette write protected", 0x00
MSG_SECTOR_NOT_FOUND: DB "Sector not found", 0x00
MSG_HDD_RESET_FAILED: DB 0x00
MSG_DISKETTE_CHANGED: DB "Diskette changed", 0x00
MSG_HDD_BAD_TABLE: DB 0x00
MSG_DMA_OVERRUN: DB "DMA overrun", 0x00
MSG_DMA_64K_ACCESS: DB "Attempted to cross a 64 KiB DMA boundary", 0x00
MSG_HDD_BAD_SECTOR_FLAG: DB 0x00
MSG_HDD_BAD_CYLINDER: DB 0x00
MSG_INVALID_MEDIA: DB "Unsupported track", 0x00
MSG_HDD_INVALID_NUMBER_OF_SECTORS: DB 0x00
MSG_HDD_CONTROLLED_DATA_ADDRESS_MARK: DB 0x00
MSG_HDD_DMA_LEVEL_OUT_OF_RANGE: DB 0x00
MSG_ECC_ERROR_ON_READ: DB "ECC error on disk read", 0x00
MSG_DATA_FIXED_BY_ECC: DB "Data recovered by ECC", 0x00
MSG_CONTROLLER_ERROR: DB "Controller error", 0x00
MSG_SEEK_FAILURE: DB "Seek failed", 0x00
;
MSG_INVALID_COMMAND_OR_PROGRAM: DB "Invalid command or program", 0x00
MSG_INVALID_SYNTAX: DB "Invalid syntax", 0x00
MSG_ENTRY_NOT_FOUND: DB "Entry not found", 0x00
MSG_ENTRY_EXISTS: DB "Entry already exists", 0x00
MSG_ENTRY_IS_DIRECTORY: DB "Entry is directory", 0x00
MSG_ENTRY_NOT_DIRECTORY: DB "Entry is not directory", 0x00
MSG_DIRECTORY_NOT_EMPTY: DB "Directory is not empty", 0x00
MSG_DIRECTORY_FULL: DB "Entry limit in directory reached", 0x00
MSG_OUT_OF_SPACE: DB "No space left on disk", 0x00
MSG_DEPTH_LIMIT: DB "Directory depth limit reached", 0x00
MSG_DIRECTORY_IN_USE: DB "Directory is in use", 0x00
;
MSG_DRIVE_TIMEOUT: DB "Timeout, drive not ready", 0x00
MSG_HDD_TIMEOUT: DB 0x00
MSG_HDD_UNDEFINED: DB 0x00
MSG_HDD_WRITE_FAULT: DB 0x00
MSG_HDD_STATUS_ERROR: DB 0x00
MSG_SENSE_FAILED: DB "Sense operation failed", 0x00
MSG_TABLE_END:
...
; NO_SPACE_MSG_END:
; COMMAND_NOT_FOUND_MSG: DB "Command or program not found", 0x00
