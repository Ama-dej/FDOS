...
READ_ERROR_MSG: DB "Failed to read from disk.", 0x0A, 0x0D
READ_ERROR_MSG_END:

WRITE_ERROR_MSG: DB "Failed to write to disk.", 0x0A, 0x0D
WRITE_ERROR_MSG_END:
...
FILE_EXISTS_MSG: DB "File already exists.", 0x0A, 0x0D
FILE_EXISTS_MSG_END:
