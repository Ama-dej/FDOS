...
COMMAND_NOT_FOUND_MSG: DB "Command not found"
COMMAND_NOT_FOUND_MSG_END:

FILE_NOT_FOUND_MSG: DB "File not found"
FILE_NOT_FOUND_MSG_END:

DIR_NOT_FOUND_MSG: DB "Directory not found"
DIR_NOT_FOUND_MSG_END:

READ_ERROR_MSG: DB "Failed to read from disk"
READ_ERROR_MSG_END:

WRITE_ERROR_MSG: DB "Failed to write to disk"
WRITE_ERROR_MSG_END:

FILE_NOT_DIRECTORY_MSG: DB "The specified file is not a directory"
FILE_NOT_DIRECTORY_MSG_END:

INCORRECT_SYNTAX_MSG: DB "The syntax is incorrect"
INCORRECT_SYNTAX_MSG_END:

FILE_EXISTS_MSG: DB "File already exists"
FILE_EXISTS_MSG_END:

DIRECTORY_NOT_EMPTY_MSG: DB "The directory must be empty"
